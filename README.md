...
```bash
# Train from scratch with PPO self-play
...
Requires Python 3.10+, PyTorch, NumPy, Pygame.
...
The ceiling is architectural. A 2.3M param CNN+GRU with 3 discrete actions learns survival but not strategy. Breaking through likely needs a larger model, continuous actions, or a different training algorithm.
